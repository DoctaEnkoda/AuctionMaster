        ...
        try(
            ...
            while(resultSet.next()) {
                if(resultSet.getString(9).startsWith("BIN"))
                    AuctionMaster.auctionsHandler.auctions.put(resultSet.getString(1), new AuctionBIN(resultSet.getString(1), resultSet.getDouble(2), resultSet.getLong(3), resultSet.getString(4), resultSet.getString(5), resultSet.getString(6), resultSet.getString(7), resultSet.getString(8), resultSet.getString(9)));
                else
